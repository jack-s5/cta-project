...
```{r}
#| label: Rolling Ridership Average
#| cache: true
#| dependson: c("setup", "Create Connection")
...
```{r}
#| label: Rolling Ridership Plot
#| cache: true
#| dependson: c("setup", "Rolling Ridership Average", "Set Theme")
#| fig-width: 8
#| fig-height: 5
...
```{r}
#| label: E-Bike Start Points Graph
#| warning: false
#| fig-width: 8
#| fig-height: 5
